								...
								<div class=" justify-content-md-center">
									...
									<div class="row">
										<div class="col-12 mb-3">
											...
											<div class="input-group mb-3">
												<input type="tel" class="form-control" name="cardNumber" placeholder="Numero de Cartão Válido" autocomplete="cc-number" required autofocus value="4111 1111 1111 1111" />
      ...
      <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
            ...
            <li class="nav-item">
              <a class="nav-link link text-black display-4" href="../login.php"><button type="button" class="btn btn-outline-dark">Entrar</button></a>
            </li>
          </ul>
        </div>
      </nav>
